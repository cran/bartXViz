...
#' @seealso [bartMachine](https://cran.r-project.org/web/packages/bartMachine/index.html) which this program uses to implement Bayesian Additive Regression Trees. 
#' @seealso [SuperLearner](https://cran.r-project.org/web/packages/SuperLearner/index.html) which this program uses to implement alternative regularizers. 
#' @export
